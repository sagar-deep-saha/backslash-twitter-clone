...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex">
      {/* Left Sidebar */}
      <aside className="w-64 p-4 fixed h-screen">
        <div className="mb-4">
          <svg viewBox="0 0 24 24" className="w-8 h-8 text-white" fill="currentColor" aria-label="Twitter logo">
        ...
        <nav className="space-y-2">
          <a href="/home" className="nav-link active">
            <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor" aria-label="Home icon">
              <title>Home</title>
          ...
          <a href="/explore" className="nav-link">
            <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor" aria-label="Explore icon">
              <title>Explore</title>
          ...
          <a href="/notifications" className="nav-link">
            <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor" aria-label="Notifications icon">
          ...
          <a href="/messages" className="nav-link">
            <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor" aria-label="Messages icon">
          ...
          <a href="/bookmarks" className="nav-link">
            <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor" aria-label="Bookmarks icon">
          ...
          <a href="/profile" className="nav-link">
            <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor" aria-label="Profile icon">
              <title>Profile</title>
        ...
        <button type="button" className="btn-primary w-full mt-4">Tweet</button>
      </aside>

      {/* Main Content */}
      <main className="ml-64 flex-1 border-x border-gray-800">
            ...
            <div className="flex-1">
              ...
              <div className="flex justify-between items-center mt-4">
                <div className="flex gap-2">
                  <button type="button" className="text-[#1d9bf0] hover:bg-[#1d9bf0]/10 p-2 rounded-full">
                    <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor" aria-label="Add media">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex justify-between mt-4 max-w-md">
                    <button type="button" className="tweet-actions">
                      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor" aria-label="Reply">
                        <title>Reply</title>
                    ...
                    <button type="button" className="tweet-actions">
                      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor" aria-label="Retweet">
                        <title>Retweet</title>
                    ...
                    <button type="button" className="tweet-actions">
                      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor" aria-label="Like">
                        <title>Like</title>
                    ...
                    <button type="button" className="tweet-actions">
                      <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor" aria-label="Share">
                        <title>Share</title>
      ...
      <aside className="w-80 p-4 hidden lg:block">
        <div className="bg-gray-900 rounded-2xl p-4">
          ...
          <div className="space-y-4">
            <div className="hover:bg-gray-800 p-3 rounded-xl transition-colors">
              <p className="text-sm text-gray-500">Trending in Technology</p>
              <p className="font-bold">#SolidJS</p>
            ...
            <div className="hover:bg-gray-800 p-3 rounded-xl transition-colors">
              ...
              <p className="text-sm text-gray-500">25.2K posts</p>
            </div>
          </div>
        </div>
      </aside>
